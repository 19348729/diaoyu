 ...
 */
function getPrediction(sensors, lat, lng, fishType = 'auto', userInventory = null, spotContext = null) {
 ...
 * @returns {Promise<object>} 预测结果
 */
function getWeatherPredict(lat, lng, fishType = 'auto', userInventory = null, spotContext = null) {
